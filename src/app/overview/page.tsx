...
function GpuCard({raw, rocmVer}: { raw: RawDevice; rocmVer?: RocmVer | null }) {
    ...
    return (
        <div
            className="rounded-xl bg-neutral-800 p-4 shadow-lg ring-1 ring-neutral-700 flex flex-col gap-2 min-w-[260px]">
            ...
            {d.vramTotal && (
                <Stat label="显存" value={`${Math.round(d.vramUsed ?? 0)} / ${Math.round(d.vramTotal)} MB`}/>)}
